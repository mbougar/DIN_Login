...
import com.es.din_login.ui.components.Header
import com.es.din_login.ui.components.PasswordVisibilityToggleIcon
import com.es.din_login.viewmodel.LoginViewModel
...
fun SignInScreen(navController: NavController, viewModel: LoginViewModel = viewModel()) {
    ...
    Column(
        ...
        Column(
            ...
            Spacer(modifier = Modifier.height(16.dp))
            Button(
                onClick = { if (isLoginEnabled) navController.navigate("success") },
                modifier = Modifier.fillMaxWidth(),
